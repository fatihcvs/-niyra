...
export function SocialMatchWorkspace({ universityShortName }: { universityShortName: string }) {
  ...
  return <div className="workspace-view social-workspace">
    <header className="social-header"><div><span>{universityShortName} · SOSYALLEŞ</span><h1>Kampüste ortak noktanı bul</h1><p>Eşleşme puanı yalnızca senin seçtiğin ilgi alanları, buluşma niyetleri ve akademik ortaklıklardan hesaplanır.</p></div><button className="feature-primary" type="button" onClick={() => setTab("settings")}>Tercihleri düzenle</button></header>
