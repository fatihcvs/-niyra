...
export default function LegalPage() {
  return <main className={styles.shell}>
    ...
    <section className={styles.hero}><span>KAMPIRA MVP v1.7</span><h1>Gizlilik, kullanım ve topluluk ilkeleri</h1><p>Kampira’da hangi verilerin neden işlendiğini, güvenli kullanım kurallarını ve bir sorun olduğunda hangi yolu izleyeceğini burada bulabilirsin.</p><small>Son güncelleme: 4 Eylül 2026 · MVP v1.7</small></section>
    ...
    <footer><p>Bu metin Kampira MVP v1.7 çalışma kurallarını açıklar ve ürün geliştikçe güncellenir.</p><Link href="/">Kampira&apos;ya dön</Link></footer>
  </main>;
}
